...
class BookDetailsPage extends StatefulWidget {
  ...
  const BookDetailsPage({required this.book, required this.bbid});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                  color: const Color.fromRGBO(244, 226, 193, 1).withValues(alpha: 0.9),
                  borderRadius: BorderRadius.circular(10),
                ),
                padding: const EdgeInsets.all(16.0),
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        color: Color.fromRGBO(250, 250, 240, 1).withValues(alpha: 0.9),
                        borderRadius: BorderRadius.circular(5),
                      ),
                      padding: const EdgeInsets.all(16.0),
                      child: ExpandableText(widget.book.description ?? 'No description available.'),
                    ),
                    SizedBox(height: 16),
