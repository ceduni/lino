...
import 'package:lino/views/profile/followed_bookboxes_page.dart';
import 'package:lino/views/profile/notifications_page.dart';
import 'package:lino/views/profile/options/favourite_genres_page.dart';
import 'package:lino/views/profile/options/notifications_setting_page.dart';
import 'package:lino/views/profile/transactions_page.dart';
import 'package:get/get.dart';
import 'package:lino/views/bookboxes/book_box_page.dart';
import 'package:lino/views/login/login_page.dart';
import 'package:lino/views/forum/bookbox_selection_page.dart';
import 'package:lino/views/login/onboarding/favourite_genres_input_page.dart';
import 'package:lino/views/login/onboarding/favourite_locations_input_page.dart';
import 'package:lino/views/login/register_page.dart';
import 'package:lino/views/profile/options/modify_profile_page.dart';
import 'package:lino/views/qr_scanner/qr_scanner_page.dart';
